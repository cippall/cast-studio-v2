...
import { useAdminCommissionForms, useDeleteCommissionForm } from '@/hooks/useAdmin';
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight">Commission Forms</h1>
        <Button disabled>
      ...
      {isLoading ? (
        ...
        <EmptyState title="No forms" description="No commission form templates yet." />
      ) : (
        <div className="space-y-3">
          {forms.map((form) => (
            <Card key={form.id}>
